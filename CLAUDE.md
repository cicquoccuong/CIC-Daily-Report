...
## System
- **Version**: 2.0.0-alpha.3 | **Platform**: Python 3.12 + GitHub Actions + Google Sheets
...
├── generators/     # article_generator, summary_generator, research_generator, template_engine, nq05_filter, quality_gate, text_utils
