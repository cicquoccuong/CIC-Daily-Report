...
function menuResetTemplates() {
  ...
  var response = ui.alert(
    ...
    "• L1: 3 phần (Tổng quan + Tin nổi bật + Kết luận & Sự kiện sắp tới)\n" +
    "• L2: 3 phần (Kỹ thuật + Altcoin + Xu hướng & Sự kiện vĩ mô)\n" +
    "• L3: 4 phần (On-chain + Vĩ mô & Lịch sự kiện + Derivatives + Tổng hợp)\n" +
    "• L4: 4 phần (Sector + Sentiment & Derivatives + Sự kiện vĩ mô + Cảnh báo)\n" +
    "• L5: 6 phần (Executive + Macro + On-chain + Sector + Liên thị trường + Risk)\n\n" +
  ...
  try {
    ...
    if (result.success) {
      ui.alert(
        ...
        "Đã ghi " + result.rowsWritten + " template mới (20 phần cho 5 tier).\n\n" +
        "Cải tiến chính:\n" +
